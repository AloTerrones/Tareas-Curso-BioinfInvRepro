## Script of question 1 (Tarea.7.1)
...
df.tresrazas<-subset(fullmat, fullmat$Raza == "Reventador", fullmat$Raza == "Jala", fullmat$Raza == "Ancho")

#12) Escribe la matriz (dataframe, no?) anterior a un archivo llamado "submat.csv en /meta
submat.csv <- df.tresrazas 